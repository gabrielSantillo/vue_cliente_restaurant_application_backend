...
# post request for the endpoint restaurant-login
def post():
...
# delete request for the endpoint restaurant-login
def delete():
    # verify if the data expected to be sent was sent indeed
    ...
    # calling the procedure that will delete a restaurant token
