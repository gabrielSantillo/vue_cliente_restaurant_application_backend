...
def post():
    ...
    if(items_added.startswith('Cannot add or update a child row')):
        return make_response(json.dumps("This or these menu items id doesn't exist in the Database"), 400)
    elif(items_added[0]['row_updated'] == 1):
